class Nave {
  ...
  method accionAdicional() //metodo abstracto (convierte la clase en una clase abstracta que no se puede instanciar)
...
class NaveBaliza inherits Nave{
  ...
  method cambiarColorDeBaliza(colorNuevo){colorBaliza = colorNuevo cambioBaliza = true}

override method accionAdicional() {
  self.cambiarColorDeBaliza("verde")
  self.ponerseParaleloAlSol()
}
override method condicionAdicional(){return colorBaliza != "rojo"}
override method escapar(){self.irHaciaElSol()}
override method avisar(){self.cambiarColorDeBaliza("rojo")}
override method tienePocaActividad() {return not cambioBaliza}
}
...
class NavePasajeros inherits Nave{
  ...
  override method avisar() {self.descargar(pasajeros * 2,pasajeros)}
  ...
  class NaveCombate inherits Nave{
    ...
    method cantMensajesEmitidos() {return mensajes.size()}
    ...
    override method tienePocaActividad() {return true}
